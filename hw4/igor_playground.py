...
if __name__ == "__main__":
    ...
    for i in range(len(full_frame_list)):
        ...
        # TODO - Blue-fy image (based on cv2 BGR)
        cframe[:, :, 2] = 0 # Zero-out reds
        cframe[:, :, 1] = cframe[:, :, 1]*0.9 # greens darken by 10%
        cframe[:, :, 0] = cframe[:, :, 0]*1.7 # Blues birghten by 70%
        cframe[cframe > 255] = 255 # truncate bigger than max intensity values due to multiplication
